...
<div class="container mx-auto p-4">
    ...
    <form action="{{ route('transactions.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <select name="customer_id" class="border p-2 w-full rounded">
                ...
                @foreach($customers as $customer)
                    <option value="{{ $customer->id }}">{{ $customer->name }} (Credit: KSh {{ number_format($customer->credit, 2) }})</option>
                @endforeach
            </select>
        </div>
        ...
        <div class="mb-4">
            ...
            <div id="products-container">
                <div class="flex gap-2 mb-2 product-row">
                    ...
                    <input type="number" name="quantity[]" min="1" value="1" class="border p-2 rounded w-20 quantity-input" />
                    <span class="price-text flex-1 self-center">Total: KSh 0</span>
        ...
        <div class="mb-4">
            ...
            <span id="transaction-total" class="font-bold">KSh 0</span>
        </div>

        <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded">Save Transaction</button>
    </form>
</div>
